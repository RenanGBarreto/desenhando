...
; English localization for additional messages
  ...
  ${LangFileString} MSG_WELCOMEPAGE_TITLE          "Welcome to Excelsior Installer for v1.0"
  ...
  ${LangFileString} MSG_FEEDBACK_TEXT              "Would you like to share with us your thoughts on how we could make v1.0 better? Fill in a 5-minute feedback form and optionally enter the prize draw!"
